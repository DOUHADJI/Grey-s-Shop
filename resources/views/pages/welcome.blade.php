<x-default-layout title="Accueil">
    ...
    <x-welcome-page.products-slider-section id="popular-products" title="Most popular products" :items="$featuredProducts" />
    <x-welcome-page.products-slider-section id="latest-products" title="Just arrived" :items="$justArrivedArticles" />
